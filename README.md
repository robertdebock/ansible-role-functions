# [Ansible role functions](#ansible-role-functions)
...
If you find issues, please register them on [GitHub](https://github.com/robertdebock/ansible-role-functions/issues).
